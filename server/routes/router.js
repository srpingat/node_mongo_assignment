...
const {index,delete_multi_items,update_multi_items,save_multi_items,save_singleitem}= require('../controller/items_controller');
...
route.post('/delete_multi_items',delete_multi_items);
route.post('/update_multi_items',  update_multi_items);
route.post('/save_multi_items',auth,authRole("ADMIN"),save_multi_items);

route.post('/saveinvoice',auth,save_invoice_withgst);  
route.get('/checkqty',chkqty1);
route.post('/saveorder',saveorder_simple);
route.post('/saveitem',save_singleitem);
